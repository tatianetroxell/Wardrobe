...
namespace Wardrobe.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,Name,Photo,Color,Season,Occasion")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,Name,Photo,Color,Season,Occasion")] Top top)
        {
            if (ModelState.IsValid)
            {
